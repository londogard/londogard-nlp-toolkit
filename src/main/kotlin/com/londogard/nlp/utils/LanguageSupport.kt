...
enum class LanguageSupport {
    ar, cs, de, en, es, fi, fr, it, ja, nl, pl, pt, ru, zh, bg, bn, ca, da, el, fa, he, hi, hu, id, ko, lv, mk, ms,
    nb, ro, sh, sv, tr, uk, az, kk, ne, no, sl, tg;
    ...
    fun hasWordFrequencySupport(): Boolean = when (this) {
        ar, cs, de, en, es, fi, fr, it, ja, nl, pl, pt, ru, zh, bg, bn, ca, da, el, fa, he, hi, hu, id, ko, lv, mk, ms, nb, ro, sh, sv, tr, uk ->
            true
        else -> true
    }
