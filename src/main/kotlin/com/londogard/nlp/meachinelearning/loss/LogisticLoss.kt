...
class LogisticLoss: Loss {
    ...
    override fun loss(weights: D2Array<Float>, X: D2Array<Float>, y: D2Array<Float>): Float {
        val sigmoidVector = X.dot(weights.transpose()).sigmoid()
    ...
    override fun gradient(weights: D2Array<Float>, X: D2Array<Float>, y: D2Array<Float>): D2Array<Float> {
        val res = X.dot(weights.transpose()).sigmoid().apply { this -= y }

        val main = X.transpose().dot(res).transpose()
